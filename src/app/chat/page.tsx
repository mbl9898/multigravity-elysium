...
const MODEL_GROUPS = [
  {
    ...
    dot: 'bg-blue-400',
    models: [
      { id: 'gemini-3-flash', label: 'Gemini 3 Flash',     sub: 'Fast · efficient' },
      { id: 'gemini-3-pro',   label: 'Gemini 3 Pro',       sub: 'Most capable' },
      { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', sub: 'Prev gen' },
      { id: 'gemini-2.5-pro',   label: 'Gemini 2.5 Pro',   sub: 'Prev gen pro' },
    ],
  },
  {
    group: 'Claude',
    ...
    dot: 'bg-orange-400',
    models: [
      { id: 'claude-sonnet-4-5',          label: 'Claude Sonnet 4.5',         sub: 'Balanced' },
      { id: 'claude-opus-4-5',            label: 'Claude Opus 4.5',           sub: 'Most capable' },
      { id: 'claude-sonnet-4-5-thinking', label: 'Claude Sonnet 4.5 Thinking',sub: 'Extended reasoning' },
      { id: 'claude-opus-4-5-thinking',   label: 'Claude Opus 4.5 Thinking',  sub: 'Best reasoning' },
      { id: 'claude-3-5-sonnet',          label: 'Claude 3.5 Sonnet',         sub: 'Classic reliable' },
      { id: 'claude-3-5-haiku',           label: 'Claude 3.5 Haiku',          sub: 'Ultra fast' },
    ],
  },
] as const;
