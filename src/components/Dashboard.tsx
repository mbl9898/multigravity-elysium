...
import {
  ...
  getResetRemainingMs,
  isPoolExhausted,
  getPoolRecoveryTimeMs,
  sortAccounts,
} from '@/lib/sorting';

export { getResetRemainingMs, isPoolExhausted, getPoolRecoveryTimeMs, sortAccounts };
...
export function Dashboard() {
  ...
  // Sort accounts using shared sorting logic
  const sortedAccounts = sortAccounts(filteredAccounts, sortMode, now);
